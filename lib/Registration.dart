            ...
            child: GestureDetector(
              ...
              child: SizedBox(
                ...
                child: Stack(
                  children: <Widget>[
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(0.0, 84.0, 192.0, 20.0),
                      size: Size(192.0, 104.0),
                      pinLeft: true,
                      pinRight: true,
                      pinBottom: true,
                      fixedHeight: true,
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(1.2, 0.0, 189.5, 71.9),
                      size: Size(192.0, 104.0),
                      pinLeft: true,
                      pinRight: true,
                      pinTop: true,
