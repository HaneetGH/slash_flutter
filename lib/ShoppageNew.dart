...
import './Shoppagewhishlistadded.dart';
import './ProductPage.dart';
import './UploadBill.dart';
import 'package:flutter_svg/flutter_svg.dart';

class ShoppageNew extends StatelessWidget {
  ShoppageNew({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            offset: Offset(355.0, 51.0),
            child: PageLink(
              links: [
                PageLinkInfo(
                  ease: Curves.easeIn,
                  duration: 0.2,
                  pageBuilder: () => Shoppagewhishlistadded(),
                ),
              ],
              child: Container(
                width: 46.0,
